...
# Setup logging
logging.basicConfig(filename='Junior_Dev_s3_access.log', filemode='w', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
if __name__ == "__main__":
    ...
    logging.info("\nUploading an object:")
    upload_object(s3_client, bucket_name, "Paper-Demo/my-upload-test_JuniorDev.csv", file_name_to_upload)
